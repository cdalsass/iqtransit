...
*/
    ...
    public ServiceAlert(String id, int cause,  int effect, String description_text) {
        this.cause = cause;
        this.effect = effect;
        this.id = id;
    ...
    public boolean store(MySQL mysql) throws SQLException {
        ...
        String query = "REPLACE INTO service_alert_history (id, created, cause, effect, description_text) values (?, now(),?,?,?)";
